...
const Navbar = () => {
  return (
    <div className="h-20 px-4 md:px-8 lg:px-16 xl:px-32 2xl:px-64 bg-white/80 backdrop-blur-lg fixed top-0 w-full z-50 transition-all border-b border-gray-100">
      {/* MOBILE */}
